...
void to_variant(const eosio::checksum256& o, fc::variant& v);
} // namespace fc
...
extern const eosio::chain::name evmutil_account;
extern const eosio::chain::name evmin_account;

using namespace eosio;
using namespace eosio::chain;

class evmutil_tester : public eosio::testing::base_tester {
   public:
   using testing::base_tester::push_action;

   static constexpr eosio::chain::name token_account = "tethertether"_n;
    
   static constexpr eosio::chain::name faucet_account_name = "faucet.xsat"_n;
   static constexpr eosio::chain::name evmutil_account = "evmutil.xsat"_n;
   ...
   static constexpr eosio::chain::name btc_token_account = "btc.xsat"_n;
    ...
    transaction_trace_ptr bridgereg(eosio::chain::name receiver, eosio::chain::name handler, eosio::chain::asset min_fee, vector<account_name> extra_signers={"evm.xsat"_n});
